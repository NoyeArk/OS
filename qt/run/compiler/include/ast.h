...
static std::ofstream CodeOutFile("D:/qtonline/run/compiler/code.txt", std::ios::out);
static std::ofstream SemanticOutFile("D:/qtonline/run/compiler/output.txt", std::ios::trunc);
