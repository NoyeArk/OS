...
struct Message {
    std::string communicationObject;
    std::string type;
    std::vector<short> addrToWrite;
    short dataBlockId;
};


class ProcessCommunication
//        class ProcessCommunication : public QThread
{
private:
...
public:
    ...
    static std::string ShakeReceive(std::string type);
    static void Send(std::string type, const std::string& command, const std::vector<short>& blocksNum, const std::string& dataToWrite = "");
    static void ShakeSend(std::string type, const std::string& command, const std::vector<short>& blocksNum, const std::string& dataToWrite = "");
};
